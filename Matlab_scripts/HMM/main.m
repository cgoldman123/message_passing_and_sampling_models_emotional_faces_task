...
elseif strcmp(env_sys, 'mac')
    ...
    tutorialPath = [ '/Users/fengli/Documents/Active-Inference-Model-for-Advise-Task/Active-Inference-Tutorial-Scripts-main'];
...
bounded01_fields = { ...
    'p_hs_la','p_correct','p_stay','p_high_intensity','p_low_intensity'...
};
